...
public class Pair<T> {
   ...
   * 
   * @param newFirst the new value for the first element of this pair
   * @throws NullPointerException if <tt>newFirst</tt> is <tt>null</tt>.
   */
  public void setFirstElement(final T newFirst) {
    if (newFirst == null) {
      throw new NullPointerException();
    }
   ...
   * 
   * @param newSecond the new value for the second element of this pair
   * @throws NullPointerException if <tt>newSecond</tt> is <tt>null</tt>.
   */
  public void setSecondElement(final T newSecond) {
    if (newSecond == null) {
      throw new NullPointerException();
    }
  ...
  public void swapElements() {
    final T temp = this.firstElement;
