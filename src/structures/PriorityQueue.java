...
public interface PriorityQueue<E> {
   ...
   * 
   * precondition: the element must be comparable to the other elements in the priority
   *       queue.
   * postcondition: element is placed in the priority queue
   * postcondition: size is incremented by 1
   * 
   * @param the_element the element to enqueue
   */
  void enqueue(E the_element);
   ...
   * postcondition the previously highest priority element has been removed from the
   *       priority queue
